...
public class TSmmParser extends Parser {
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 5:
				...
				setState(160);
				((StatementContext)_localctx).i1 = ifBlock();
				((StatementContext)_localctx).ast =  new IfStatement(((StatementContext)_localctx).expression.ast.getLine(), ((StatementContext)_localctx).expression.ast.getColumn(), ((StatementContext)_localctx).expression.ast, ((StatementContext)_localctx).i1.ast, new ArrayList<>());
				}
				break;
			case 6:
	...
	public final VarDefinitionsContext varDefinitions() throws RecognitionException {
		...
		try {
			...
			bucle.add((((VarDefinitionsContext)_localctx).ID!=null?((VarDefinitionsContext)_localctx).ID.getText():null));
			setState(244);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==T__20) {
			...
			match(T__22);
			        ...
			        if(bucle.contains(((VarDefinitionsContext)_localctx).ids.get(k).getText()) && bucle.get(k)!=((VarDefinitionsContext)_localctx).ids.get(k).getText()){
			            _localctx.ast.add(
			                            new VarDefinition(
